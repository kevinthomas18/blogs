...
const DiscussionForum = () => {
  ...
  const handleCreateThread = () => {
    // Handle thread creation logic here, e.g., submit to API
    console.log("Thread created:", newThreadTitle, newThreadContent);
      ...
      <div className="container mx-auto px-14 mt-14">
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="flex-1">
            ...
            <ul>
              {topics.map((topic) => (
                <li key={topic.id} className="border-b py-4 flex items-center">
                  <img
                  ...
                  <div className="flex-shrink-0 text-right">
                    <div className="text-gray-700">{topic.replies} Replies</div>
          ...
          {/* Sidebar */}
          <div className="lg:w-1/4 lg:pl-14 mt-8 lg:mt-0">
            {/* Featured Threads */}
            <div className="mb-8">
              ...
              <ul>
                {featuredThreads.map((thread) => (
                  <li key={thread.id} className="mb-4">
                    <a href="#" className="text-grey-600 hover:underline">
                      {thread.title}
                    </a>
                    <div className="text-sm text-gray-500">
